...
function getCustomMode()
    return {
        Name = NameTextBox.Text ~= "" and NameTextBox.Text or "CUSTOM",
        Walkspeed = 50,
        moveVal = 15,
        Font = Enum.Font.Arcade,
        StrokeColor = C3.N(.5, .5, .5),
        Music = tonumber(MusicTextBox.Text) or 0,
        LeftWing = {0, BrickColor.new("White").Color, Enum.Material.Neon},
        RightWing = {0, BrickColor.new("White").Color, Enum.Material.Neon},
        WingAnim = WingAnimTextBox.Text ~= "" and WingAnimTextBox.Text or "StarL"
    }
end
