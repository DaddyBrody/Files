getgenv().Evolution = {
  ["Options"] = {
      ...
      ["Internal"] = {
          ...
          ["Bind"] = "N", -- // Default keybind to toggle ui
      },
      ...
      ["Notifcation Duration"] = 2, -- // How long notifcations will show
  },
  ["Silent Aim"] = {
      ...
      ["Prediction"] = 0.1994554, -- // Prediction Value
      ...
      ["Line"] = false, -- // Visual 
      ["Shake"] = {
          ["Enabled"] = true, -- // Will Randomly Offset hit point
          ["X"] = 5, -- // Max X Position
          ["Y"] = 10, -- // Max Y Position
          ["Z"] = 10, -- // Max Z Position
      },
  ...
  ["Cam Lock"] = {
      ...
      ["Target Mode Bind"] = "F", -- // Keybind for Target modes
      ...
      ["Prediction"] = 0.1652131, -- // Prediction Value
      ["Target Part"] = "Head", -- // Any Hitbox (Head, UpperTorso, HumanoidRootPart, LowerTorso)
      ["Target Part Offset"] = 0, -- // Offset if you have the target part to head and you set offset to -1.6 you will hit the torso
      ["Nearest Part To Cursor"] = false,  -- // Sets target part to the nearest body part to your cursor
      ...
      ["Smoothness"] = {
          ...
          ["Value"] = 0.59883, -- // Smoothness Value
      },
      ["Shake"] = {
          ["Enabled"] = true, -- // Will Shake your camera randomly when targeting
          ["X"] = 3, -- // Max X Position
          ["Y"] = 2, -- // Max Y Position
          ["Z"] = 5, -- // Max Z Position
      },
  ...
  ["Resolver"] = {
      ...
      ["Keybind Enabled"] = true, -- // Will toggle resolver when you press key
      ["Keybind"] = "Z", -- // Keybind to toggle resolver
  },
  ["FOV"] = { -- // FOV Circle Settings
      ...
      ["Cam Lock"] = {
          ...
          ["Thickness"] = 0.5, -- // Thickness of the circle
  ...
  ["Emotes"] = { -- // Da hood and Hood Modded only (if you have the animation ids for other da hood ripoffs dm xz)
      ...
      ["Greet"] = true, ["GreetKey"] = Enum.KeyCode.B, -- // Will Play Greet Animation when you press the keybind
...
GetPrediction = function() 
  if Evolution["Global"]["Auto Prediction"].Enabled then 
      ...
      if string.lower(Evolution.Global["Auto Prediction"]["Version"]) == "default" then 
          return tonumber(PingNumber / 300 * 0.12511 + 0.1195839)
...
if Evolution["Options"]["Internal"].Enabled then 
  if Evolution_UI_LOADED then 
      ...
      local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/23Asmo/evolutionfixes/main/themes'))()
      local ThemeManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/laagginq/LinoriaUI/main/themes.lua'))()
      local SaveManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/23Asmo/evolutionfixes/main/linoria-save'))()
      --local SaveManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/23Asmo/evolutionfixes/main/pastebinshit'))()
